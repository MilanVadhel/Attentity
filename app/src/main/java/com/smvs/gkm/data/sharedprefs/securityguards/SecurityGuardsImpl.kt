package com.smvs.gkm.data.sharedprefs.securityguards

import android.content.Context
import android.content.SharedPreferences
import com.app.gofood.data.sharedprefs.SecurityGuards
import com.app.gofood.data.sharedprefs.cipher.KeystoreCipher
import com.app.gofood.data.sharedprefs.cipher.KeystoreCipherImpl
import com.smvs.gkm.BuildConfig
import com.smvs.gkm.data.sharedprefs.utils.KeystoreWrapper
...
class SecurityGuardsImpl @Inject constructor(
    ...
    init {
        ...
        try {
            ...
            * */
            Timber.e("initial error : $illegalStateException")
            reset()
             ...
             */
            Timber.e("initial error : $illegalArgumentException")
            reset()
             ...
             * specified algorithm.
             */
            Timber.e("initial error : $noSuchAlgorithmException")
            reset()
             ...
             */
            Timber.e("initial error : $noSuchPaddingException")
            reset()
             ...
             */
            Timber.e("initial error : $invalidKeyException")
            reset()
             ...
             */
            Timber.e("initial error : ${badPaddingException.localizedMessage}")
            reset()
        } catch (aBte: AEADBadTagException) {
            /*
             * @exception AEADBadTagException if this cipher is decrypting in an
             * AEAD mode (such as GCM/CCM), and the received authentication tag
             * does not match the calculated value
             */
            Timber.e("initial error : ${aBte.localizedMessage}")
            reset()
        }
    }
